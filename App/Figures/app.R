...
# ## RUn this code from a separate R terminal. yOu may need to copy the map from shinyapp.R
# rsconnect::deployApp('C:\\Users\\maecj\\OneDrive - Nexus365\\A DPhil\\Simulation studies\\Programs\\Study 1\\SimulationStudy1_11Jun2024\\SimulationStudy\\App\\Figures')
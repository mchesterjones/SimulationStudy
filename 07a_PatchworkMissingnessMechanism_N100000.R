...
data_mar_100000 <- MAR_Long %>% filter(samplesize=="N=100,000") %>%
  mutate(mechanism = "MAR") 
## %>%
##  filter(Method != "Validation data, no missingness")
data_mnar_100000 <- MNAR_Long %>% filter(samplesize=="N=100,000") %>%
...
################
auc_params <- list(
  list(parameter ="Outcome prevalence 1% and Missingness 25%", x_limits = c(0.7, 0.85), x_breaks = seq(0.7, 1, by = 0.05), width=0.001,
       intercept =no_missing_long$AVG[no_missing_long$Metric == "AUC"& no_missing_long$df=="simresults_Yprev1Rprev75"]),
  list(parameter ="Outcome prevalence 1% and Missingness 50%", x_limits = c(0.7, 0.85), x_breaks = seq(0.7, 1, by = 0.05), width=0.001, 
       intercept =no_missing_long$AVG[no_missing_long$Metric == "AUC"& no_missing_long$df=="simresults_Yprev1Rprev75"]),
  list(parameter ="Outcome prevalence 1% and Missingness 75%", x_limits = c(0.7, 0.85), x_breaks = seq(0.7, 1, by = 0.05), width=0.001, 
       intercept =no_missing_long$AVG[no_missing_long$Metric == "AUC"& no_missing_long$df=="simresults_Yprev1Rprev75"]),
  list(parameter ="Outcome prevalence 5% and Missingness 25%", x_limits = c(0.7, 0.85), x_breaks = seq(0.7, 1, by = 0.05), width=0.001,
       intercept =no_missing_long$AVG[no_missing_long$Metric == "AUC"& no_missing_long$df=="simresults_Yprev5Rprev75"]),
  list(parameter ="Outcome prevalence 5% and Missingness 50%", x_limits = c(0.7, 0.85), x_breaks = seq(0.7, 1, by = 0.05), width=0.001, 
       intercept =no_missing_long$AVG[no_missing_long$Metric == "AUC"& no_missing_long$df=="simresults_Yprev5Rprev75"]),
  list(parameter ="Outcome prevalence 5% and Missingness 75%", x_limits = c(0.7, 0.85), x_breaks = seq(0.7, 1, by = 0.05), width=0.001, 
       intercept =no_missing_long$AVG[no_missing_long$Metric == "AUC"& no_missing_long$df=="simresults_Yprev5Rprev75"]),
  list(parameter ="Outcome prevalence 10% and Missingness 25%", x_limits = c(0.7, 0.85), x_breaks = seq(0.7, 1, by = 0.05), width=0.001, 
       intercept =no_missing_long$AVG[no_missing_long$Metric == "AUC"& no_missing_long$df=="simresults_Yprev10Rprev75"]),
  list(parameter ="Outcome prevalence 10% and Missingness 50%", x_limits = c(0.7, 0.85), x_breaks = seq(0.7, 1, by = 0.05), width=0.001, 
       intercept =no_missing_long$AVG[no_missing_long$Metric == "AUC"& no_missing_long$df=="simresults_Yprev10Rprev75"]),
  list(parameter ="Outcome prevalence 10% and Missingness 75%", x_limits = c(0.7, 0.85), x_breaks = seq(0.7, 1, by = 0.05), width=0.001,
       intercept =no_missing_long$AVG[no_missing_long$Metric == "AUC"& no_missing_long$df=="simresults_Yprev10Rprev75"]))
...
############################
citl_params <- list(
  list(parameter ="Outcome prevalence 1% and Missingness 25%", x_limits = c(-0.5, 0.35), x_breaks = seq(-0.5, 0.35, by = 0.25), width=0.05,
       intercept =no_missing_long$AVG[no_missing_long$Metric == "Cal_Int"& no_missing_long$df=="simresults_Yprev1Rprev75"]),
  list(parameter ="Outcome prevalence 1% and Missingness 50%", x_limits = c(-0.5, 0.35), x_breaks = seq(-0.5, 0.35, by = 0.25), width=0.05,
       intercept =no_missing_long$AVG[no_missing_long$Metric == "Cal_Int"& no_missing_long$df=="simresults_Yprev1Rprev75"]),
  list(parameter ="Outcome prevalence 1% and Missingness 75%", x_limits = c(-0.5, 0.35), x_breaks = seq(-0.5, 0.35, by = 0.25), width=0.05,
       intercept =no_missing_long$AVG[no_missing_long$Metric == "Cal_Int"& no_missing_long$df=="simresults_Yprev1Rprev75"]),
  list(parameter ="Outcome prevalence 5% and Missingness 25%", x_limits = c(-0.5, 0.35), x_breaks = seq(-0.5, 0.35, by = 0.25), width=0.05, 
       intercept =no_missing_long$AVG[no_missing_long$Metric == "Cal_Int"& no_missing_long$df=="simresults_Yprev5Rprev75"]),
  list(parameter ="Outcome prevalence 5% and Missingness 50%", x_limits = c(-0.5, 0.35), x_breaks = seq(-0.5, 0.35, by = 0.25), width=0.05,
       intercept =no_missing_long$AVG[no_missing_long$Metric == "Cal_Int"& no_missing_long$df=="simresults_Yprev5Rprev75"]),
  list(parameter ="Outcome prevalence 5% and Missingness 75%", x_limits = c(-0.5, 0.35), x_breaks = seq(-0.5, 0.35, by = 0.25), width=0.05, 
       intercept =no_missing_long$AVG[no_missing_long$Metric == "Cal_Int"& no_missing_long$df=="simresults_Yprev5Rprev75"]),
  list(parameter ="Outcome prevalence 10% and Missingness 25%", x_limits = c(-0.5, 0.35), x_breaks = seq(-0.5, 0.35, by = 0.25), width=0.05, 
       intercept =no_missing_long$AVG[no_missing_long$Metric == "Cal_Int"& no_missing_long$df=="simresults_Yprev10Rprev75"]),
  list(parameter ="Outcome prevalence 10% and Missingness 50%", x_limits = c(-0.5, 0.35), x_breaks = seq(-0.5, 0.35, by = 0.25), width=0.05, 
       intercept =no_missing_long$AVG[no_missing_long$Metric == "Cal_Int"& no_missing_long$df=="simresults_Yprev10Rprev75"]),
  list(parameter ="Outcome prevalence 10% and Missingness 75%", x_limits = c(-0.5, 0.35), x_breaks = seq(-0.5, 0.35, by = 0.25), width=0.05, 
       intercept =no_missing_long$AVG[no_missing_long$Metric == "Cal_Int"& no_missing_long$df=="simresults_Yprev10Rprev75"]))
...
##########################
rmse_params <- list(
  list(parameter ="Outcome prevalence 1% and Missingness 25%", x_limits = c(0.002, 0.3), x_breaks = seq(0, 0.40, by = 0.1), width=0.0001,
       intercept =no_missing_long$AVG[no_missing_long$Metric == "rmse"& no_missing_long$df=="simresults_Yprev1Rprev75"]),
  list(parameter ="Outcome prevalence 1% and Missingness 50%", x_limits = c(0.002, 0.3), x_breaks = seq(0, 0.4, by = 0.1), width=0.0001,
  intercept =no_missing_long$AVG[no_missing_long$Metric == "rmse"& no_missing_long$df=="simresults_Yprev1Rprev75"]),
  list(parameter ="Outcome prevalence 1% and Missingness 75%", x_limits = c(0.002, 0.3), x_breaks = seq(0, 0.4, by = 0.1), width=0.0001,
       intercept =no_missing_long$AVG[no_missing_long$Metric == "rmse"& no_missing_long$df=="simresults_Yprev1Rprev75"]),
  list(parameter ="Outcome prevalence 5% and Missingness 25%", x_limits = c(0.002, 0.3), x_breaks = seq(0, 0.4, by = 0.1), width=0.0001,
       intercept =no_missing_long$AVG[no_missing_long$Metric == "rmse"& no_missing_long$df=="simresults_Yprev5Rprev75"]),
  list(parameter ="Outcome prevalence 5% and Missingness 50%", x_limits = c(0.002, 0.3), x_breaks = seq(0, 0.4, by = 0.1), width=0.0001,
       intercept =no_missing_long$AVG[no_missing_long$Metric == "rmse"& no_missing_long$df=="simresults_Yprev5Rprev75"]),
...
for (measure_name in names(plot_storage)) {
  ...
  patchwork_storage[[measure_name]] <- list()
    ...
    output_file <- paste0("Patchwork_MissingnessMechanism_", measure_name, ".pdf")

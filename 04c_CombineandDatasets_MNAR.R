...
#  
 ...
 ##############################################################################
 setwd("C:\\Users\\maecj\\OneDrive - Nexus365\\A DPhil\\Simulation studies\\Programs\\Study 1\\SimulationStudy1_11Jun2024\\SimulationStudy\\Data")
 load("MNAR_100000_Combined.Rdata")
 load("MNAR_100000_Combined_Long.Rdata")
 ...
 save(combined_df,file = "MNAR_Combined.Rdata")
 save(simulation_parameters_long,file = "MNAR_Combined_Long.Rdata")

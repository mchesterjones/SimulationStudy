...
# load("MNAR_Nval_500_Yprev_0.01_Rprev_0.25_25Nov2024.Rdata")
# simresults_Yprev1Rprev25 <- simulation_results
# load("MNAR_Nval_500_Yprev_0.01_Rprev_0.5_25Nov2024.Rdata")
# simresults_Yprev1Rprev50 <- simulation_results
# load("MNAR_Nval_500_Yprev_0.01_Rprev_0.75_25Nov2024.Rdata")
# simresults_Yprev1Rprev75 <- simulation_results
# load("MNAR_Nval_500_Yprev_0.05_Rprev_0.25_25Nov2024.Rdata")
# simresults_Yprev5Rprev25 <- simulation_results
# load("MNAR_Nval_500_Yprev_0.05_Rprev_0.5_25Nov2024.Rdata")
# simresults_Yprev5Rprev50 <- simulation_results
# load("MNAR_Nval_500_Yprev_0.05_Rprev_0.75_25Nov2024.Rdata")
# simresults_Yprev5Rprev75 <- simulation_results
# load("MNAR_Nval_500_Yprev_0.1_Rprev_0.25_25Nov2024.Rdata")
# simresults_Yprev10Rprev25 <- simulation_results
# load("MNAR_Nval_500_Yprev_0.1_Rprev_0.5_25Nov2024.Rdata")
# simresults_Yprev10Rprev50 <- simulation_results
# load("MNAR_Nval_500_Yprev_0.1_Rprev_0.75_25Nov2024.Rdata")
...
# setwd("H:\\SimulationStudyHDrive\\Data\\")
# ## Load required datasets 
# load("MNAR_Nval_1e+05_Yprev_0.01_Rprev_0.25_25Nov2024.Rdata")
# simresults_Yprev1Rprev25 <- simulation_results
# ## Set working directory    
# setwd("H:\\SimulationStudyHDrive\\Data\\")
# CHANGE
...
## Load datasets
 ...
 # save(combined_df,file = "MNAR_500_Combined_26Nov2024.Rdata")
 # save(simulation_parameters_long,file = "MNAR_500_Combined_Long_26Nov2024.Rdata")
 # 
 # 
 ##############################################################################
 # Combine with no missingness 
...
#  
#  # Store all values at each iteraiton 
#  save(combined_df,file = "MNAR_10000_Combined_26Nov2024.Rdata")
#  save(simulation_parameters_long,file = "MNAR_10000_Combined_Long_26Nov2024.Rdata")
#  
#  
 ##############################################################################
 # Combine with no missingness 
 ...
 # Store all values at each iteraiton 
 save(combined_df,file = "MNAR_100000_Combined_26Nov2024.Rdata")
 save(simulation_parameters_long,file = "MNAR_100000_Combined_Long_26Nov2024.Rdata")